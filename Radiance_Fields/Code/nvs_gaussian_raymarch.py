# Novel view synthesis in flatland using point-based primitives: Gaussian blobs with ray marching
...
num_blobs = 4        # number of Gaussians to use
max_harmonic = 2
...
def integrate_ray(params, position, direction):
    ...
    while t > min_dist:
        ...
        density, color = compute_visual_density_and_colour(params, current_position, angle)
